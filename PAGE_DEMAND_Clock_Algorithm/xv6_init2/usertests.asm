    ...
    2d36:	31 ff                	xor    %edi,%edi
{
  ...
  for(i = 0; i < 50; i++){
    2d90:	83 ff 32             	cmp    $0x32,%edi
    2d93:	75 db                	jne    2d70 <sbrktest+0x40>
  pid = fork();
    2d95:	e8 00 0b 00 00       	call   389a <fork>
  if(pid < 0){
    2d9a:	85 c0                	test   %eax,%eax
  pid = fork();
    2d9c:	89 c7                	mov    %eax,%edi
  if(pid < 0){
    2d9e:	0f 88 85 03 00 00    	js     3129 <sbrktest+0x3f9>
  c = sbrk(1);
    2da4:	83 ec 0c             	sub    $0xc,%esp
  if(c != a + 1){
    2da7:	83 c6 02             	add    $0x2,%esi
  c = sbrk(1);
    2daa:	6a 01                	push   $0x1
    2dac:	e8 79 0b 00 00       	call   392a <sbrk>
  c = sbrk(1);
    2db1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2db8:	e8 6d 0b 00 00       	call   392a <sbrk>
  if(c != a + 1){
    2dbd:	83 c4 10             	add    $0x10,%esp
    2dc0:	39 f0                	cmp    %esi,%eax
    2dc2:	0f 85 4a 03 00 00    	jne    3112 <sbrktest+0x3e2>
  if(pid == 0)
    2dc8:	85 ff                	test   %edi,%edi
    2dca:	0f 84 3d 03 00 00    	je     310d <sbrktest+0x3dd>
  wait();
    2dd0:	e8 d5 0a 00 00       	call   38aa <wait>
  a = sbrk(0);
    2dd5:	83 ec 0c             	sub    $0xc,%esp
    2dd8:	6a 00                	push   $0x0
    2dda:	e8 4b 0b 00 00       	call   392a <sbrk>
    2ddf:	89 c6                	mov    %eax,%esi
  amt = (BIG) - (uint)a;
    2de1:	b8 00 00 40 06       	mov    $0x6400000,%eax
    2de6:	29 f0                	sub    %esi,%eax
  p = sbrk(amt);
    2de8:	89 04 24             	mov    %eax,(%esp)
    2deb:	e8 3a 0b 00 00       	call   392a <sbrk>
  if (p != a) {
    2df0:	83 c4 10             	add    $0x10,%esp
    2df3:	39 c6                	cmp    %eax,%esi
    2df5:	0f 85 fb 02 00 00    	jne    30f6 <sbrktest+0x3c6>
  a = sbrk(0);
    2dfb:	83 ec 0c             	sub    $0xc,%esp
  *lastaddr = 99;
    2dfe:	c6 05 ff ff 3f 06 63 	movb   $0x63,0x63fffff
  a = sbrk(0);
    2e05:	6a 00                	push   $0x0
    2e07:	e8 1e 0b 00 00       	call   392a <sbrk>
  c = sbrk(-4096);
    2e0c:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2e13:	89 c6                	mov    %eax,%esi
  c = sbrk(-4096);
    2e15:	e8 10 0b 00 00       	call   392a <sbrk>
  if(c == (char*)0xffffffff){
    2e1a:	83 c4 10             	add    $0x10,%esp
    2e1d:	83 f8 ff             	cmp    $0xffffffff,%eax
    2e20:	0f 84 b9 02 00 00    	je     30df <sbrktest+0x3af>
  c = sbrk(0);
    2e26:	83 ec 0c             	sub    $0xc,%esp
    2e29:	6a 00                	push   $0x0
    2e2b:	e8 fa 0a 00 00       	call   392a <sbrk>
  if(c != a - 4096){
    2e30:	8d 96 00 f0 ff ff    	lea    -0x1000(%esi),%edx
    2e36:	83 c4 10             	add    $0x10,%esp
    2e39:	39 d0                	cmp    %edx,%eax
    2e3b:	0f 85 87 02 00 00    	jne    30c8 <sbrktest+0x398>
  a = sbrk(0);
    2e41:	83 ec 0c             	sub    $0xc,%esp
    2e44:	6a 00                	push   $0x0
    2e46:	e8 df 0a 00 00       	call   392a <sbrk>
    2e4b:	89 c6                	mov    %eax,%esi
  c = sbrk(4096);
    2e4d:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
    2e54:	e8 d1 0a 00 00       	call   392a <sbrk>
  if(c != a || sbrk(0) != a + 4096){
    2e59:	83 c4 10             	add    $0x10,%esp
    2e5c:	39 c6                	cmp    %eax,%esi
  c = sbrk(4096);
    2e5e:	89 c7                	mov    %eax,%edi
  if(c != a || sbrk(0) != a + 4096){
    2e60:	0f 85 4b 02 00 00    	jne    30b1 <sbrktest+0x381>
    2e66:	83 ec 0c             	sub    $0xc,%esp
    2e69:	6a 00                	push   $0x0
    2e6b:	e8 ba 0a 00 00       	call   392a <sbrk>
    2e70:	8d 96 00 10 00 00    	lea    0x1000(%esi),%edx
    2e76:	83 c4 10             	add    $0x10,%esp
    2e79:	39 d0                	cmp    %edx,%eax
    2e7b:	0f 85 30 02 00 00    	jne    30b1 <sbrktest+0x381>
  if(*lastaddr == 99){
    2e81:	80 3d ff ff 3f 06 63 	cmpb   $0x63,0x63fffff
    2e88:	0f 84 0c 02 00 00    	je     309a <sbrktest+0x36a>
  a = sbrk(0);
    2e8e:	83 ec 0c             	sub    $0xc,%esp
    2e91:	6a 00                	push   $0x0
    2e93:	e8 92 0a 00 00       	call   392a <sbrk>
  c = sbrk(-(sbrk(0) - oldbrk));
    2e98:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  a = sbrk(0);
    2e9f:	89 c6                	mov    %eax,%esi
  c = sbrk(-(sbrk(0) - oldbrk));
    2ea1:	e8 84 0a 00 00       	call   392a <sbrk>
    2ea6:	89 d9                	mov    %ebx,%ecx
    2ea8:	29 c1                	sub    %eax,%ecx
    2eaa:	89 0c 24             	mov    %ecx,(%esp)
    2ead:	e8 78 0a 00 00       	call   392a <sbrk>
  if(c != a){
    2eb2:	83 c4 10             	add    $0x10,%esp
    2eb5:	39 c6                	cmp    %eax,%esi
    2eb7:	0f 85 c6 01 00 00    	jne    3083 <sbrktest+0x353>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    2ebd:	be 00 00 00 80       	mov    $0x80000000,%esi
    ppid = getpid();
    2ec2:	e8 5b 0a 00 00       	call   3922 <getpid>
    2ec7:	89 c7                	mov    %eax,%edi
    pid = fork();
    2ec9:	e8 cc 09 00 00       	call   389a <fork>
    if(pid < 0){
    2ece:	85 c0                	test   %eax,%eax
    2ed0:	0f 88 96 01 00 00    	js     306c <sbrktest+0x33c>
    if(pid == 0){
    2ed6:	0f 84 6e 01 00 00    	je     304a <sbrktest+0x31a>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    2edc:	81 c6 50 c3 00 00    	add    $0xc350,%esi
    wait();
    2ee2:	e8 c3 09 00 00       	call   38aa <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    2ee7:	81 fe 80 84 1e 80    	cmp    $0x801e8480,%esi
    2eed:	75 d3                	jne    2ec2 <sbrktest+0x192>
  if(pipe(fds) != 0){
    2eef:	8d 45 b8             	lea    -0x48(%ebp),%eax
    2ef2:	83 ec 0c             	sub    $0xc,%esp
    2ef5:	50                   	push   %eax
    2ef6:	e8 b7 09 00 00       	call   38b2 <pipe>
    2efb:	83 c4 10             	add    $0x10,%esp
    2efe:	85 c0                	test   %eax,%eax
    2f00:	0f 85 31 01 00 00    	jne    3037 <sbrktest+0x307>
    2f06:	8d 7d c0             	lea    -0x40(%ebp),%edi
    2f09:	89 fe                	mov    %edi,%esi
    2f0b:	eb 23                	jmp    2f30 <sbrktest+0x200>
    if(pids[i] != -1)
    2f0d:	83 f8 ff             	cmp    $0xffffffff,%eax
    2f10:	74 14                	je     2f26 <sbrktest+0x1f6>
      read(fds[0], &scratch, 1);
    2f12:	8d 45 b7             	lea    -0x49(%ebp),%eax
    2f15:	83 ec 04             	sub    $0x4,%esp
    2f18:	6a 01                	push   $0x1
    2f1a:	50                   	push   %eax
    2f1b:	ff 75 b8             	pushl  -0x48(%ebp)
    2f1e:	e8 97 09 00 00       	call   38ba <read>
    2f23:	83 c4 10             	add    $0x10,%esp
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    2f26:	8d 45 e8             	lea    -0x18(%ebp),%eax
    2f29:	83 c6 04             	add    $0x4,%esi
    2f2c:	39 c6                	cmp    %eax,%esi
    2f2e:	74 52                	je     2f82 <sbrktest+0x252>
    if((pids[i] = fork()) == 0){
    2f30:	e8 65 09 00 00       	call   389a <fork>
    2f35:	85 c0                	test   %eax,%eax
    2f37:	89 06                	mov    %eax,(%esi)
    2f39:	75 d2                	jne    2f0d <sbrktest+0x1dd>
      sbrk(BIG - (uint)sbrk(0));
    2f3b:	83 ec 0c             	sub    $0xc,%esp
    2f3e:	6a 00                	push   $0x0
    2f40:	e8 e5 09 00 00       	call   392a <sbrk>
    2f45:	ba 00 00 40 06       	mov    $0x6400000,%edx
    2f4a:	29 c2                	sub    %eax,%edx
    2f4c:	89 14 24             	mov    %edx,(%esp)
    2f4f:	e8 d6 09 00 00       	call   392a <sbrk>
      write(fds[1], "x", 1);
    2f54:	83 c4 0c             	add    $0xc,%esp
    2f57:	6a 01                	push   $0x1
    2f59:	68 b1 46 00 00       	push   $0x46b1
    2f5e:	ff 75 bc             	pushl  -0x44(%ebp)
    2f61:	e8 5c 09 00 00       	call   38c2 <write>
    2f66:	83 c4 10             	add    $0x10,%esp
